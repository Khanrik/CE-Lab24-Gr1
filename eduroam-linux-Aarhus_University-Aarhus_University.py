...
Config.instname = "Aarhus University"
Config.profilename = "Aarhus University"
Config.url = "http://au.dk/it"
Config.email = "health.it@au.dk"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.au.dk"
...
Config.del_ssids = ['AU-Guest']
Config.servers = ['DNS:eduroam.au.dk']
